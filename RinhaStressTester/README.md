...
> Este arquivo README, bem como toda esta ferramenta de teste foi construída de forma cretina e mandrake no estilo vibe coding usando GitHub Copilot Agent Mode baseado no modelo Claude Sonnet 4
